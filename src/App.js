...
function App() {
  const { personal, navigation, about, workExperience, personalProjects, education } = portfolioData;
        ...
        <section className="mt-12 md:mt-16">
          ...
          <div className="space-y-6 md:space-y-8">
            {education.institutions.map((institution) => (
              <div key={institution.id} className="border border-gray-700 p-4 md:p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start gap-3 sm:gap-4 mb-4">
                  <span className="text-gray-400 text-sm md:text-base order-2 sm:order-1">
                    {institution.period}
                  </span>
